...
1. Write your code or your notes in a text file, and save them with the .Rmd file extension. Use numbers at the start of the file name, eg `01-my-first-note.Rmd`, `02-thoughts-on-Laurence-1999.Rmd`. Make sure you're saving within the notebook folder.
2. From the command line, type `make`
3. Add your changes to git.
4. Make a commit.
5. Push your changes to your gh-pages branch of your notebook.
